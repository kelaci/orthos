...
Welcome, Agent. This repository, **GAIA (Generalized Adaptive Intelligent Architecture)**, is designed with a high degree of modularity and scientific rigor. This document serves as your primary guide to understanding, maintaining, and extending the codebase efficiently.

## 🎯 Your Mission

Your goal is to assist in the research and development of GAIA while maintaining:
...
| :--- | :--- | :--- |
| `gaia/core/` | Base classes & types | Start here to understand the interfaces you must implement. |
| `gaia/layers/` | Core neural blocks | Where the "work" happens (Hebbian, Temporal, etc). |
| `gaia/hierarchy/` | Level management | How layers are stacked and time-scaled. |
| `gaia/plasticity/` | Learning logic | The brain of the adaptation system. |
...
- `/refactor-layer`: Steps for modifying a core layer in `gaia/layers/`.
