...
4.  **Test-Driven Execution**: If a bug is reported, your first step is to write a failing test in `test_orthos.py`.
...
- **Run Command**: Always use `python test_orthos.py` as your final verification step.
