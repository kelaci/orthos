...
try:
    ...
    from gaia.core.gpu_utils import CUPY_AVAILABLE
...
def benchmark_operations():
    ...
    print("\n" + "="*70)
    print("🚀 GAIA GPU BENCHMARK - Basic Operations")
    print("="*70)
...
def benchmark_hierarchy_sizes():
    ...
    print("\n" + "="*70)
    print("🏗️ GAIA GPU BENCHMARK - Hierarchy Scaling")
    print("="*70)
...
def benchmark_memory_usage():
    ...
    print("\n" + "="*70)
    print("💾 GAIA GPU BENCHMARK - Memory Usage")
    print("="*70)
...
def run_comprehensive_benchmark():
    ...
    print("\n" + "="*70)
    print("🚀 GAIA v4.x COMPREHENSIVE GPU BENCHMARK")
    print("="*70)
    ...
    if CUPY_AVAILABLE:
        ...
        print("```python")
        print("from gaia.core.gpu_utils import set_device, get_device")
        print("")
        print("# Use GPU")
...
def test_gpu_integration():
    """Test GPU integration with actual GAIA components."""
    print("\n" + "="*70)
    print("🧪 GAIA GPU INTEGRATION TEST")
    print("="*70)
    
    try:
        from gaia.core.gpu_utils import GPUContext, to_gpu, to_cpu, get_array_module
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("🧠 GAIA GPU BENCHMARK SUITE")
    print("="*70)
    print("Testing GPU acceleration capabilities for GAIA v4.x")
    print("="*70)
